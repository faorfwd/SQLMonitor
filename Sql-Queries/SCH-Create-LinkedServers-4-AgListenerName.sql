...
declare @GrafanaLoginPassword nvarchar(256);
...
EXEC master.dbo.sp_addlinkedsrvlogin @rmtsrvname=@_alias_server_name, @useself=N'False',@locallogin=NULL,@rmtuser=N'grafana',@rmtpassword=@GrafanaLoginPassword;
