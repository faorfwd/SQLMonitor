...
begin
	...
	from (values 
			...
			('url_for_alertengine_website',
				'https://alertengine.ajaydwivedi.com/',
					'Grafana Dashboard for Alerts'),
			...
			('email_delivery_enabled','1','Global kill switch: 0 disables all sp_send_dbmail calls across SQLMonitor'),
